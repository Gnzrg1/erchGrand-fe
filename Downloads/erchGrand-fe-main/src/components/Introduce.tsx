    ...
    <div className="sm:px-16 flex flex-col gap-8" id="aboutUs">
      <div className="flex flex-col lg:flex-row gap-8">
        <div className="w-full lg:w-2/5 flex flex-col gap-4">
          ...
          <p className="text-white">“Эрч Гранд” ХХК нь 2010 оноос эхлэн автозасвар үйлчилгээ, автосэлбэгийн худалдаа эрхлэх чиглэлээр үйл ажиллагаа явуулж эхэлсэн. 2025 оны 6 дугаар сараас эхлэн тээврийн хэрэгслийн техникийн хяналтын үзлэгийн үйл ажиллагааг явуулж байна.</p>
        </div>
