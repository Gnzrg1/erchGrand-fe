    ...
    <div className="sm:px-16 flex flex-col lg:flex-row gap-12" id="serviceSection">
      <div className="w-full lg:w-1/3 lg:h-[60vh] flex flex-col justify-between items-start gap-4">
        ...
        <div className="h-2/4 h-[36vh] w-full px-4 py-4 flex justify-start items-end" id="wheel-alignment">
          <Link href="UzlegOrder"><Typography 
          className="h-10 w-80 bg-white rounded-lg flex justify-center items-center text-black"
          aria-owns={open ? 'mouse-over-popover' : undefined}
          aria-haspopup="true"
          onMouseEnter={handlePopoverOpen}
          onMouseLeave={handlePopoverClose}
          >Техник хяналтын үзлэг цаг авах</Typography></Link>
          <Popover
      ...
      <div className="w-full h-[60vh] lg:w-1/3 flex flex-col gap-12">
        <div className="w-full h-2/4 flex justify-start items-end px-4 py-4" id="smart-diagnosis">
          <Typography className="h-10 w-[150px] bg-white rounded-lg flex justify-center items-center text-black"
          aria-owns={open2 ? 'mouse-over-popover' : undefined}
          aria-haspopup="true"
          onMouseEnter={handlePopoverOpen1}
          onMouseLeave={handlePopoverClose1}>Cмарт оношлогоо</Typography>
           <Popover
        id="mouse-over-popover"
        sx={{
          pointerEvents: 'none',
        ...
        disableRestoreFocus
      >
        <Typography sx={{ p: 1 }} className="opacity-70 bg-slate-200">Үнэ: 44,000-66,000</Typography>
      </Popover>
        </div>
        <div className="w-full h-2/4 flex justify-start items-end px-4 py-4" id="wheel-alignment">
          ...
          onMouseLeave={handlePopoverClose4}>Тэнхлэг тохиргоо</Typography>
           <Popover
        id="mouse-over-popover"
        sx={{
          pointerEvents: 'none',
        ...
        disableRestoreFocus
      >
        <Typography sx={{ p: 1 }} className="opacity-70 bg-slate-200">Үнэ: 55,000-99,000 </Typography>
      </Popover>
        </div>
        </div>
      <div className="w-full h-[60vh] lg:w-1/3 flex flex-col gap-12">
