...
export default function UlzegOrder() {
  ...
  useEffect(() => {
    if(dateVal){
      axios.post(`${Utils.API_URL}/techs` , dateVal)
      .then((res) => setOrderVal(res.data.result?.time))
        ...
        <div className="p-[50px] bg-black shadow-shadow-dashboard">
          <div className="mb-[30px]">
            <h1 className="text-head text-white text-[30px] font-bold leading-9 mb-2">
              Техник хяналтын үзлэгийн цаг захиалах
            </h1>
          </div>
